...
from maproomfortuneteller import *
...
class MaproomfortunetellerBosque(Maproomfortuneteller):
    "Fortune teller house at Bosque"
    def __init__(self):
	Maproomfortuneteller.__init__(self)	
	self.roomnumber = 1.2
	...
	label2 = Labelxoffset(340,70,100,14,self.font,"See power",box,24)
	label3 = Labelxoffset(340,90,100,14,self.font,"Listen Knowledge",box,24)
	label4 = Labelxoffset(340,110,100,14,self.font,"Record Experience",box,24)
	box.addchild(label1)
	...
	self.locationtext = "The Sage Marid"
